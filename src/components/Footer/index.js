...
export default function Footer() {
    return (
        <footer class="text-gray-600 body-font bg-[#222053]">
                ...
                <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <div class="list-none mb-10">
                            ...
                            <li class="pb-1">
                                <a class="text-gray-400 hover:text-gray-500" href="#">Get to Know Us</a>
                            </li>
                            <li>
            ...
            <div >
                <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p class="text-green-200 text-sm text-center sm:text-left">© Manhattan Barbershop</p>
